...
module.exports = {
  ...
  build: {
    ...
    index: path.join(process.env.API_PATH || process.cwd(), process.env.API_OUTPUT || './doc/page', 'index.html'),
    assetsRoot: path.join(process.env.API_PATH || process.cwd(), process.env.API_OUTPUT || './doc/page'),
    assetsSubDirectory: 'static',
    assetsPublicPath: '/',
